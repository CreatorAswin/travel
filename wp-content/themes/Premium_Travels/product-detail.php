            ...
            <div class="row" style="display: flex; flex-wrap: wrap; margin: 0 -15px;">
                ...
                <div class="col-md-8" style="flex: 0 0 65%; max-width: 65%; padding: 0 15px;">
                    <div class="product-gallery" style="position: sticky; top: 20px;">
                        <div class="main-image" style="background: #fff; border-radius: 12px; overflow: hidden; box-shadow: var(--shadow-sm); margin-bottom: 15px; height: 400px; display: flex; align-items: center; justify-content: center;">
                            <?php 
                            // Try multiple methods to get product image
                            $image_found = false;
                            
                            // Method 1: WordPress featured image
                            if (has_post_thumbnail()) {
                                the_post_thumbnail('large', array('style' => 'max-width: 100%; max-height: 100%; object-fit: contain;'));
                                $image_found = true;
                            }
                            
                            // Method 2: Check if this is coming from a WordPress post
                            if (!$image_found && $post && has_post_thumbnail($post->ID)) {
                                echo get_the_post_thumbnail($post->ID, 'large', array('style' => 'max-width: 100%; max-height: 100%; object-fit: contain;'));
                                $image_found = true;
                            }
                            
                            // Method 3: Default image placeholder
                            if (!$image_found): ?>
                                <div style="text-align: center; color: #ccc; font-size: 14px; padding: 20px;">
                                    ...
                                    <div style="font-size: 12px; margin-top: 10px; color: #999;">Add featured image in WordPress admin</div>
                                </div>
                            <?php endif; ?>
                        </div>
                        ...
                        <div class="thumbnails" style="display: flex; gap: 10px;">
                            <div style="width: 80px; height: 80px; background: #f8f9fa; border-radius: 8px; border: 2px solid #e9ecef; display: flex; align-items: center; justify-content: center; cursor: pointer;">
